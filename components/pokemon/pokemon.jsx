...
import {Link, IconButton, Box, HStack, Flex, Button, Text, VStack, Center, Alert, AlertIcon, Divider,
    FormControl, Input, NumberInput, Slider, NumberInputField, SliderTrack, SliderFilledTrack, SliderThumb, Tooltip, Select, Stat, StatLabel, StatNumber, Image
...
import { FaHandHoldingHeart, FaUsers, FaUser, FaCaretSquareUp, FaCaretSquareDown, FaCaretSquareLeft, FaCaretSquareRight} from 'react-icons/fa';
...
function GetTokens() {
    ...
    return(
        ...
        <Alert status='info'  mb="1rem">
                    <AlertIcon />
                        <Text  textAlign="center">The greater your bid, the higher your chance of winning. New auctions take place every few seconds to minutes, and your bid can remain active for multiple auctions. For more information check out our blog post <Link style={{textDecoration: "underline"}} href="/blog/pokemon_guide">here</Link>. </Text>
...
function MainFunction()
{
    ...
    return(
        ...
        <AlertIcon />
        {
            <Text textAlign="center">Take part in the DaoPlays Pokemon token launch to pay what you want for an initial block of Play Tokens <Link style={{textDecoration: "underline"}} href="/pokemon/token_launch"> here</Link>!</Text>
        }
        </Alert>
        <br/><br/>
        <StatsBlock />
