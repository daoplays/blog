...
export const PROGRAM = new PublicKey("E2ConrgkPx3tc7oKbt4phBiBsKuXoh1FWBr82znSipX1");
...
class Create_Collection_Instruction {
    ...
    static readonly struct = new FixableBeetStruct<Create_Collection_Instruction>(
        ...
        (args) => new Create_Collection_Instruction(args.instruction!, args.name!, args.uri!),
...
export function serialise_CreateCollection_instruction(name: string, uri: string): Buffer {
    const data = new Create_Collection_Instruction(OptionsInstruction.create_collection, name, uri);
...
export function serialise_CreateOption_instruction(
    ...
    const data = new Create_Option_Instruction(OptionsInstruction.create_option, name, uri, token_amount, side, end_date, strike, price);
