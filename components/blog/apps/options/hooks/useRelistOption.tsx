...
const useRelistOption = () => {
    ...
    const check_signature_update = useCallback(async (result: any) => {
        ...
        toast.success("Successfuly Listed Option!", {
            type: "success",
            isLoading: false,
            autoClose: 3000,
        });
    ...
    const RelistOption = async (asset: PublicKey, collection: PublicKey, new_price: string) => {
    ...
    return { RelistOption, isLoading };
};

export default useRelistOption;
