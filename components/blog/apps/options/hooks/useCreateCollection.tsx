...
import { PROGRAM, CORE, SYSTEM_KEY, serialise_CreateCollection_instruction } from "../state";
...
const useCreateCollection = (name: string, uri: string, token_mint: string) => {
    ...
    const GetCreateCollectionInstruction = async (base_mint_string: string, quote_mint_string: string) => {
        ...
        const instruction_data = serialise_CreateCollection_instruction(name + " Options", uri);
