...
const useRefundOption = () => {
    ...
    const check_signature_update = useCallback(async (result: any) => {
        ...
        toast.success("Successfuly Refunded Option!", {
            type: "success",
            isLoading: false,
            autoClose: 3000,
        });
    ...
    const RefundOption = async (
        ...
        const instruction_data = serialise_basic_instruction(OptionsInstruction.refund);
    ...
    return { RefundOption, isLoading };
};

export default useRefundOption;
