...
import { PROGRAM, CORE, SYSTEM_KEY, serialise_CreateCollection_instruction, serialise_CreateOption_instruction } from "../state";
...
const useCreateOption = (name: string, uri: string, token_mint: string) => {
    ...
    const { GetCreateCollectionInstruction, isLoading: isCollectionLoading } = useCreateCollection(name, uri, token_mint);
    ...
    const CreateOption = async (
        ...
        let launchDateString = splitLaunchDate[1] + " " + splitLaunchDate[2] + " " + splitLaunchDate[3];
