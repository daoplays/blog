...
class MintCounter {
    ...
    static readonly struct = new BeetStruct<MintCounter>([["counter", u64]], (args) => new MintCounter(args.counter!), "MintCounter");
}
...
function Tokens2022App() {
    ...
    const Transfer = useCallback(async () => {
        ...
        const idx_data = new Transfer_Token_Instruction(TokenInstruction.transfer, 1000);
                    ...
                    {include_metadata && (
                        <>
                            ...
                            <VStack width="100%" align="left">
                                <TextInputBox setValue={setName} display_value={name} key_string="Token Name" current_ref={name_rate_ref} />
                                ...
                                <TextInputBox setValue={setURI} display_value={uri} key_string="Token URI" current_ref={uri_ref} />
                            </VStack>
                        </>
                    )}
                    {include_transfer && (
