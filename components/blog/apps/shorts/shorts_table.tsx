            ...
            <TableContainer w="100%">
                <table width="100%" className="custom-centered-table font-face-rk">
                    <thead>
                        ...
                        >
                            {tableHeaders.map((i) => (
                                <th key={i.text} style={{ color: "white", minWidth: sm ? "90px" : "110px" }}>
...
const LaunchCard = ({
    ...
    let borrow_fee = Math.floor(time_delta_years * annual_borrow_fee + 1) / Math.pow(10, fee_decimals);
            ...
            >
                ...
                <td style={{ minWidth: "150px" }}>
                    {mode === 0 && (
                        <Button
                            onClick={() => {
                                direction === "short" ? ExitShort(amm, asset) : ExitLong(amm, asset);
                            }}
                    ...
                    {mode === 1 && (
                        <Button
                            onClick={() => {
                                direction === "short" ? LiquidateShort(amm, asset) : LiquidateLong(amm, asset);
                            }}
                            style={{ textDecoration: "none" }}
                        >
                            Liquidate
