...
import { SYSTEM_KEY, DEV_RPC_NODE, DEV_WSS_NODE, uInt32ToLEBytes, CORE, serialise_basic_instruction } from "../../common";
...
const useExitShort = () => {
    ...
    const check_signature_update = useCallback(async (result: any) => {
        ...
        toast.success("Exited Short Position!", {
            type: "success",
            isLoading: false,
            autoClose: 3000,
        });
    ...
    const ExitShort = async (amm_data: AMMData, asset: AssetV1) => {
        ...
        const instruction_data = serialise_basic_instruction(AMMInstruction.exit_short);
