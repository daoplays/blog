...
import { CORE, SYSTEM_KEY, DEV_RPC_NODE, DEV_WSS_NODE, serialise_basic_instruction } from "../../common";
...
const useCreateCollection = () => {
    ...
    const GetCreateCollectionInstruction = async (base_mint_string: string, quote_mint_string: string) => {
        ...
        const instruction_data = serialise_basic_instruction(AMMInstruction.create_collection);
