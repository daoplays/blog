                ...
                <VStack align="start" spacing={1}>
                    ...
                    <HStack spacing={3} align="start" justify="start">
                        ...
                        <Tooltip label="View in explorer" hasArrow fontSize="large" offset={[0, 10]}>
                            <Link href={getSolscanLink(amm.amm_data.base_mint.toString())} target="_blank" onClick={(e) => e.stopPropagation()}>
    ...
    let base_output_string =
        base_output === 0
            ...
            : base_output <= 1e-3
              ...
              : base_output.toLocaleString("en-US", { minimumFractionDigits: base_data.mint.decimals, maximumFractionDigits: base_data.mint.decimals });
