                    ...
                    <VStack px={lg ? 4 : 12} spacing={25}>
                                ...
                                <HStack w="100%" spacing={lg ? 10 : 12} style={{ flexDirection: lg ? "column" : "row" }}>
                                    {base_token ? (
                                        ...
                                        <VStack
                                            justify="center"
                                            align="center"
                                            style={{ minWidth: lg ? 180 : 180, minHeight: lg ? 180 : 180, cursor: "pointer" }}
                                            borderRadius={12}
                        ...
                        <HStack mt={md ? 0 : 30}>
                            <button
                                ...
                                onClick={() => {
                                    InitAMM(base_address, quote_address, parseFloat(base_amount), parseFloat(quote_amount), parseInt(swap_fee), parseInt(short_fraction), parseInt(borrow_cost));
                                }}
                            >
                                Create
                            </button>
