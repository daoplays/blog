...
const team_lookup_schema = new Map([[TeamLookupData, { kind: "struct", fields: [["team_account", [32]]] }]]);
...
const myu64_schema = new Map([[MyU64, { kind: "struct", fields: [["number", "u64"]] }]]);
...
export function IceCreamApp() {
    ...
    const Create = useCallback(async () => {
        ...
        try {
            await wallet.sendTransaction(new Transaction().add(create_team_meta_instruction), connection);
    ...
    const Eat = useCallback(async () => {
        ...
        try {
            await wallet.sendTransaction(new Transaction().add(eat_instruction), connection);
        } catch (error) {
            console.log(error);
        }
                        ...
                        {wallet.publicKey && (
                            <>
                                                    ...
                                                    <VStack>
                                                        <Box height="40px" width="450px">
                                                            {current_team_score != null && (
                                                                <FormControl id="check_team_name" maxWidth={"450px"}>
                                                                    <Input type="text" value={current_team_score} readOnly />
                                                                </FormControl>
                                                            )}
                                                            {current_team_score == null && (
                                                                <FormControl id="check_team_name" maxWidth={"450px"}>
                                                        ...
                                                        <Box height="40px" width="450px">
                                                            <a
                                                                ...
                                                                href={"https://solscan.io/account/" + team_token}
                                                            >
                                                                <FormControl id="check_team_name" maxWidth={"450px"}>
                                                                    <Input type="text" value={team_token} readOnly />
                                                                </FormControl>
                                                            </a>
                                                        </Box>
                                                    </VStack>
                                            ...
                                            <VStack>
                                                ...
                                                <Box height="40px" width="350px">
                                                    <FormControl id="existing_mint" maxWidth={"350px"}>
                                                        <Input type="text" value={existing_mint} onChange={handleMintChange} />
                                                    </FormControl>
                                                </Box>
                                            </VStack>
                                        </HStack>
                                ...
                                {team_name !== "" && (
                                    <>
                                        <Text mt="2rem" mb="1rem" textAlign="center" fontSize="1.5rem">
                                            Step 2: Eat (Click) the food to score points for your team!
                                        </Text>
                                        <Center>
                                            <Box width="20%" height="20%" mt="2rem" mb="2rem">
                                                <Figure>
                                                    <a href="#!">
                                                        <Figure.Image fluid={true} src={picture} onClick={Eat} />
                                                    </a>
                                                    <Figure.Caption>
                                                        Photo by{" "}
                                                        <a
                                                        ...
                                                        <a
                                                            style={{ textDecoration: "underline" }}
                                                            href={"https://unsplash.com/?utm_source=ice_cream_battle&utm_medium=referral"}
                                                        >
                                                            Unsplash
                                                        </a>
                                                    </Figure.Caption>
