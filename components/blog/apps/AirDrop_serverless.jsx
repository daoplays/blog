...
import { ChakraProvider, Box, Button, HStack, theme, Input, FormControl } from "@chakra-ui/react";
                ...
                <Box>
                    <HStack marginBottom="10px">
                        <FormControl id="balance" maxWidth={"250px"}>
                            <Input
                                type="text"
                                value={lamports ? "Balance: " + lamports / LAMPORTS_PER_SOL + " SOL" : "Balance: Loading.."}
                                readOnly
                            />
                        </FormControl>
