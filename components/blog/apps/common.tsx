...
import { Mint, TOKEN_2022_PROGRAM_ID, TOKEN_PROGRAM_ID, getMetadataPointerState, getPermanentDelegate, getTokenMetadata, getTransferFeeConfig, getTransferHook, unpackMint } from "@solana/spl-token";
import {
    Connection,
    PublicKey,
} from "@solana/web3.js";
...
import { Metadata } from "@metaplex-foundation/mpl-token-metadata";
  ...
  export const DEV_RPC_NODE =
    "https://nickie-qn2k6r-fast-devnet.helius-rpc.com";
  export const DEV_WSS_NODE =
    "wss://devnet.helius-rpc.com/?api-key=8c0a541e-cdf4-4c1e-8bf9-de66a1962d6f";
