...
export const PROGRAM = new PublicKey("326p2wwfCBU36E52VShvsuh8WHkLenmbnEbxbKf3ja6z");
...
export const DEV_RPC_NODE = "https://black-damp-river.solana-devnet.quiknode.pro/c5447e06dd58dec2f4568518d8fb2fd8625b1d95/";
...
export function serialise_CreateAsset_instruction(instruction: number, name : string, uri : string): Buffer {
    const data = new Create_Asset_Instruction(
        instruction,
        name,
        uri
    );
...
export function serialise_CreateTransfer_instruction(): Buffer {
    const data = new Transfer_Instruction(
        2
    );
