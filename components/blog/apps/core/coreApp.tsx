                    ...
                    <VStack px={lg ? 4 : 12} spacing={25}>
                        <HStack w="100%" spacing={lg ? 10 : 12} style={{ flexDirection: lg ? "column" : "row" }}>
                            ...
                            <VStack spacing={8} flexGrow={1} align="start" width="100%">
                                ...
                                <HStack spacing={0} className={styles.eachField}>
                                    <div className={`${styles.textLabel} font-face-kg`} style={{ color:"black", minWidth: lg ? "100px" : "132px" }}>
                                        Name:
                                    </div>
                        ...
                        <HStack mt={md ? 0 : 30}>
                            ...
                            <button
                                ...
                                style={{ borderColor:"black", borderWidth: "1px", cursor: isCollectionLoading ? "not-allowed" : "pointer" }}
                            >
...
function SetTokenOptions({collection, token,  setToken} : {collection : PublicKey, token : PublicKey, setToken: Dispatch<SetStateAction<PublicKey>>}) {
        ...
        <Center borderColor="black" borderWidth="1px" width="100%">
            <VStack w="100%" style={{ paddingBottom: md ? 35 : "75px" }}>
                <HStack>
                    ...
                    <Link className="font-face-kg" color={"black"} fontSize="x-large" m="0" p="0" style={{textDecoration: "underline"}}
                    ...
                    <VStack px={lg ? 4 : 12} spacing={25}>
                        ...
                        <HStack mt={md ? 0 : 30}>
                            ...
                            <button
                                ...
                                className={`${styles.nextBtn}`}
                                style={{ borderColor:"black", borderWidth: "1px", cursor: isNFTLoading ? "not-allowed" : "pointer" }}
                            >
                        ...
                        <>
                            ...
                            <button
                                ...
                                className={`${styles.nextBtn}`}
                                style={{ borderColor:"black", borderWidth: "1px", cursor: (isTransferLoading || token === null) ? "not-allowed" : "pointer" }}
                            >
                                {"Transfer"}
                            </button>
