    ...
    return (
        <div className="home" style={{ fontSize: 18 }}>
            <div className="container">
                <h1 className="h1 text-center mb-0 pt-3 font-weight-bold text-body">Going Short With AMMs</h1>
                <h1 className="h5 text-center mb-1 pt-0 font-weight-bold text-secondary">May 26 2024</h1>
                <br />
                <br />
