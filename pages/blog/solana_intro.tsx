...
function SolletBlock() {
  ...
  return (
      ...
      <Box>
          ...
          <HighLightCode codeBlock={"solana-keygen recover \"prompt://?full-path=m/44'/501'/0'/0'\" -o phantom_0.json"} language={"bash"}/>
...
`
  ...
  return (
    <>
      ...
      <Center>
        <VStack align="center">
        <Heading as="h1" size='2xl'>Getting Started With Solana</Heading>
