    ...
    return (
        <div className="home" style={{ fontSize: 18 }}>
            <div className="container">
                ...
                the size of the account we will include <Code p="0">TransferFeeConfig</Code> and <Code p="0">InterestBearingConfig</Code> ,
                which both have the Config suffix, whereas others are simply called, for example, <Code p="0">DefaultAccountState</Code>
                .
                <br />
                <br />
                <HighLightCode codeBlock={extension_size} language={"rust"} />
                With the size of the mint account calculate, we can now use the <Code p="0">create_account</Code> function to actually
                create the account, making sure to pass the token_2022 program id rather than the standard token program.
                <br />
                <br />
                ...
                instruction to actually mint the tokens, rather than the original <Code p="0">mint_to</Code>. This is because when including
                the Fee Transfer extension mint_to will simply fail to transfer the tokens, whereas mint_to_checked is backwards compatible
                and so will transfer with or without the Transfer Fee extension enabled.
                <br />
                <br />
                <h3 id="tokens-header" className="mt-5" style={{ fontSize: "20px" }}>
                    Test Application
