    ...
    return (
        <div className="home" style={{ fontSize: 18 }}>
            <div className="container">
                ...
                the size of the account we will include <Code p="0">TransferFeeConfig</Code> and{" "}
                <Code p="0">InterestBearingConfig</Code> , which both have the Config suffix, whereas others are simply called,
                for example, <Code p="0">DefaultAccountState</Code>
                .
                <br />
                <br />
                ...
                With the size of the mint account calculate, we can now use the <Code p="0">create_account</Code> function to
                ...
                instruction to actually mint the tokens, rather than the original <Code p="0">mint_to</Code>. This is because
