...
{`output = sublayer(input) + input`}
            ...
            <Text>
              Layer normalization is crucial for stabilizing the learning process in deep networks. There are two main approaches to applying layer normalization in transformer models:
            </Text>
