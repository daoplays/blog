            ...
            <HStack h={20} px={5} position="fixed" top={0} w="full" alignItems="center" justify="space-between">
                ...
                >
                    <Tooltip label="Coming Soon" hasArrow>
                        <Text cursor="not-allowed" m={0} color="white" fontSize="2xl" className="font-face-wc" opacity="50%">
                            Shop
                        </Text>
                    </Tooltip>
                    <Tooltip label="Coming Soon" hasArrow>
                ...
                <VStack w="500px" border="1px solid white" p={6} rounded="xl" shadow="xl">
                    ...
                    <HStack>
                        ...
                        <Box position="relative" h="250px" w="250px" mt={2} border="1px dashed white" rounded="xl">
                            ...
                            />
                            <HStack bg="white" rounded="lg" p={1} px={2} gap={1} position="absolute" bottom={2} right={2}>
