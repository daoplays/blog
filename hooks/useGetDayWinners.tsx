...
export const useGetDaysWinners = () => {
    ...
    return useCallback(
        async (date: number, setDayRows: React.Dispatch<React.SetStateAction<DayRow[]>>) => {
            ...
            for (let i = 0; i < max_index; i++) {
                ...
                let entry_account = PublicKey.findProgramAddressSync(
        ...
        [database, entryList, userIDs, leaderboardList, twitterList],
