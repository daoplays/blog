...
const useListItem = () => {
    ...
    const ListItem = async (item_type: number, item: PublicKey, quantity: number, price: number) => {
        ...
        let instructions = await GetAddListingInstruction(wallet.publicKey, item, item_type, quantity, price);
